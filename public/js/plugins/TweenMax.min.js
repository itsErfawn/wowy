 ...
 *
 * @license Copyright (c) 2008-2015, GreenSock. Designed by TikiTheme. All rights reserved..
                        ...
                        (t >= f
                            ? ((this._totalTime = f),
                              ...
                              0 === g &&
                                  ...
                                  (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > v || v === a) && v !== t && ((i = !0), v > a && (r = "onReverseComplete")), (this._rawPrevTime = c = !e || t || v === t ? t : a)))
                            : 1e-7 > t
            ...
            function (t, e, i) {
                ...
                return (
                    ...
                    (d._remove = function (t, i) {
                        ...
                        var s = this._last
                        return (
                            s ? this._time > s._startTime + s._totalDuration / s._timeScale && ((this._time = this.duration()), (this._totalTime = this._totalDuration)) : (this._time = this._totalTime = this._duration = this._totalDuration = 0), this
                        )
                    }),
                                ...
                                o &&
                                    (this._gc ||
                                        ((p === this._startTime || m !== this._timeScale) &&
                                            ...
                                            (n && (h.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[o] && this._callback(o))))
                        }
                    }),
                    ...
                    (h.render = function (t, e, i) {
                        ...
                        if (t >= f)
                            this._locked || ((this._totalTime = f), (this._cycle = this._repeat)),
                                this._reversed ||
                                    this._hasPausedChild() ||
                                    ((n = !0), (h = "onComplete"), (_ = !!this._timeline.autoRemoveChildren), 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && ((_ = !0), y > r && (h = "onReverseComplete"))),
                                (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r),
                            ...
                            h &&
                                (this._locked ||
                                    ...
                                    ((g === this._startTime || v !== this._timeScale) &&
                                        ...
                                        (n && (a.length && o(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[h] && this._callback(h))))
                    }),
                    ...
                    init: function (t, e, i) {
                        ...
                        for (n = this._props.length; --n > -1; )
                            (s = this._props[n]),
                                ...
                                o || (h[s] !== l[0][s] && (o = h))
                        if (
                            ((this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? u(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o) : c(l, e.type, h)),
                            ...
                            parser: function (t, e, n, a, o, l) {
                                ...
                                return (
                                    ...
                                    !d.autoRotate ||
                                        ...
                                        ((h = d.autoRotate === !0 ? 0 : Number(d.autoRotate)), (d.autoRotate = null != u.end.left ? [["left", "top", "rotation", h, !1]] : null != u.end.x ? [["x", "y", "rotation", h, !1]] : !1)),
                ...
                var _,
                    ...
                    J = function (t, e, i, s, r) {
                        ...
                        for (a in i)
                            "cssText" !== a &&
                                ...
                                ((l[a] = "auto" !== n || ("left" !== a && "top" !== a) ? (("" !== n && "auto" !== n && "none" !== n) || "string" != typeof e[a] || "" === e[a].replace(y, "") ? n : 0) : H(t, a)),
                    ...
                    se = function (t, e) {
                        ...
                        return (
                            ...
                            e &&
                                ((e.oxp = -1 !== s.indexOf("%")), (e.oyp = -1 !== r.indexOf("%")), (e.oxr = "=" === s.charAt(1)), (e.oyr = "=" === r.charAt(1)), (e.ox = parseFloat(s.replace(y, ""))), (e.oy = parseFloat(r.replace(y, ""))), (e.v = t)),
                            e || t
                        )
                    },
                    re = function (t, e) {
                        ...
                        return (
                            ...
                            i || 0 === o || a.plugin
                                ? (a.l++,
                                  ...
                                  (a["xs" + a.l] = s || ""),
                                  o > 0
                                      ? ((a.data["xn" + o] = e + i), (a.rxp["xn" + o] = r), (a["xn" + o] = e), a.plugin || ((a.xfirst = new me(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)), (a.xfirst.xs0 = 0)), a)
                        ...
                        B.setTransformRatio =
                            function (t) {
                                ...
                                ;(h = 1),
                                    ...
                                    O || A
                                        ? ((T += x + (m > l && l > -m ? w : l) + x + (m > u && u > -m ? w : u) + x + (m > s && s > -m ? w : s)), (T += x + (m > a && a > -m ? w : a) + x + (m > h && h > -m ? w : h) + x + (m > c && c > -m ? w : c) + x))
                                        : (T += ",0,0,0,0,1,0,"),
                ...
                ;(h = Oe.prototype),
                    ...
                    Te("clip", {
                        ...
                        parser: function (t, e, i, s, n, a) {
                            ...
                            return (
                                9 > m
                                    ? ((l = t.currentStyle), (h = 8 > m ? " " : ","), (o = "rect(" + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ")"), (e = this.format(e).split(",").join(h)))
                                      ...
                                      "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (d && P.test(f))
                                          ...
                                          ? ((h = parseFloat(c)),
                                            ...
                                            p !== m &&
                                                ...
                                                h &&
                                                ((h = $(t, a, h, p)),
                                                "%" === m ? ((h /= $(t, a, 100, "%") / 100), e.strictUnits !== !0 && (c = h + "%")) : "em" === m || "rem" === m ? (h /= $(t, a, 1, m)) : "px" !== m && ((u = $(t, a, u, m)), (m = "px")),
                                                g && (u || 0 === u) && (f = u + h + m)),
                                            g && (u += h),
                                            (!h && 0 !== h) || (!u && 0 !== u)
                        ...
                        (s = i._next),
                            i.pg
                                ...
                                : i.n === t &&
                                  (2 === i.f && i.t
                                      ? e(i.t._firstPT)
                                      : (this._add(i.t, t, i.s, i.c), s && (s._prev = i._prev), i._prev ? (i._prev._next = s) : r._firstPT === i && (r._firstPT = s), (i._next = i._prev = null), (r._propLookup[t] = l))),
                            (i = s)
                return !1
            }),
                        ...
                        (_ = n[o]),
                            ...
                            _ === r[o] || o >= r.length
                                ...
                                : (f && (u.push(f), (f = "")),
                                  (a = parseFloat(r[o])),
                                  u.push(a),
                                  (u._firstPT = { _next: u._firstPT, t: u, p: u.length - 1, s: a, c: ("=" === _.charAt(1) ? parseInt(_.charAt(0) + "1", 10) * parseFloat(_.substr(2)) : parseFloat(_) - a) || 0, f: 0, r: p && 4 > p })),
                            (c += _.length)
                    ...
                    return (
                        "number" !== u &&
                            ...
                            "string" == typeof _ && (a || isNaN(_))
                                ? ((f.fp = a), (l = L(_, s, o || D.defaultStringFilter, f)), (f = { t: l, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 }))
