(function ($) {
    ...
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $(this).html(      
                event.strftime(''      
                    + '<span class="countdown-section"><span class="countdown-amount hover-up">%d</span><span class="countdown-period"> روز </span></span>'
                    + '<span class="countdown-section"><span class="countdown-amount hover-up">%H</span><span class="countdown-period"> ساعت </span></span>'
                    + '<span class="countdown-section"><span class="countdown-amount hover-up">%M</span><span class="countdown-period"> دقیقه </span></span>'
                    + '<span class="countdown-section"><span class="countdown-amount hover-up">%S</span><span class="countdown-period"> ثانیه </span></span>'
                )
            );           
        });
    });
    ...
    $('.product-slider-active-1').slick({
        ...
        rtl: true,
        arrows: true,
        prevArrow: '<span class="pro-icon-1-prev"><i class="far fa-angle-right"></i></span>',
        nextArrow: '<span class="pro-icon-1-next"><i class="far fa-angle-left"></i></span>',
        responsive: [
            {
                breakpoint: 1199,
                settings: {
